...
def writeTunnelRules(p4info_helper, ingress_sw, egress_sw, vni,
    ...
    table_entry = p4info_helper.buildTableEntry(
        ...
        action_name="MyIngress.vxlan_encap_ingress",
        action_params={
            "vni": vni
        })
    ...
    table_entry = p4info_helper.buildTableEntry(
        table_name="MyIngress.vxlanTunnel_exact",
        match_fields={
            "hdr.vxlan.vni": vni
        },
    ...
    table_entry = p4info_helper.buildTableEntry(
        ...
        action_name="MyIngress.vxlan_decap_egress",
        action_params={
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        writeTunnelRules(p4info_helper, ingress_sw=s1, egress_sw=s2, vni=100,
                         dst_eth_addr="08:00:00:00:02:22", dst_ip_addr="10.0.2.2")

        # Write the rules that tunnel traffic from h2 to h1
        writeTunnelRules(p4info_helper, ingress_sw=s2, egress_sw=s1, vni=200,
